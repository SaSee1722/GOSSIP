...
function Avatar(t0) {
    ...
    if ($[0] !== "dbdf2500b20bf1c5112536141da54d3d022f47ecaffc02a4654a67550dafdee3") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "dbdf2500b20bf1c5112536141da54d3d022f47ecaffc02a4654a67550dafdee3";
    }
    const { src, fallback, className } = t0;
    let t1;
    if ($[1] !== className) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$GOSSIP$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("relative w-10 h-10 rounded-full overflow-hidden bg-muted flex items-center justify-center border border-border", className);
        $[1] = className;
        $[2] = t1;
    } else {
        t1 = $[2];
...
function useCall() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$GOSSIP$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(1);
    if ($[0] !== "19b8940b27cae79308b4ac096998c1d4cddfd5ed92f15484fdfb5dc5745a39f7") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "19b8940b27cae79308b4ac096998c1d4cddfd5ed92f15484fdfb5dc5745a39f7";
    }
...
//# sourceMappingURL=Desktop_GOSSIP_src_95beae17._.js.map